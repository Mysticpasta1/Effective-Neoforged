...
//        return ReloadableShaderEffectManager.INSTANCE;
		return null; //Commented out since id is reference.
    }
...
//    @API(status = STABLE, since = "1.0.0")
     ...
     *
     * <p>This overload forwards to {@link #manageCoreShader(ResourceLocation, VertexFormat)} with {@link DefaultVertexFormat#POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL},
