 ...
 * <p>
 * Post shaders loaded through {@link ShaderEffectManager#manage(net.minecraft.resources.ResourceLocation, Consumer)} are self-managed and will be
...
//    @API(status = EXPERIMENTAL, since = "1.0.0")
     ...
     * draw, draws the {@link Minecraft#getMainRenderTarget()} main framebuffer}'s texture
     * to intermediate {@link RenderTarget framebuffers} as defined by the JSON files
