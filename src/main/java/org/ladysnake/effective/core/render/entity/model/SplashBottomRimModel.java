...
public class SplashBottomRimModel<T extends Entity> extends EntityModel<T> {
	public static final ModelLayerLocation MODEL_LAYER = new ModelLayerLocation(Effective.id("splash_bottom_rim"), "main");
	...
	public static LayerDefinition getLayerDefinition() {
		...
		modelPartData.addOrReplaceChild("splash_rim", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 0.0F, -6.0F, 12.0F, 0.0F, 12.0F), PartPose.offset(0.0F, 0.0f, 0.0F));
